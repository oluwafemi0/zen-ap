...
const Dash = () => {
  return (
    ...
    <div class="hidden md:flex sticky left-0 flex-col w-64 bg-[#262626]">
        <div class="flex items-center  justify-center h-16 bg-[#262626]">
        <a href="/" class="text-[#262626] bg-white uppercase py-2 px-16 rounded font-bold inline-flex items-center">
            tippy.
          </a>
        </div>
    ...
    <div class="flex flex-col flex-1 overflow-y-auto">
        <div>
        <div class="flex p-2 justify-between items-center bg-[#262626] h-16 border-b border-gray-300 flex-wrap">
